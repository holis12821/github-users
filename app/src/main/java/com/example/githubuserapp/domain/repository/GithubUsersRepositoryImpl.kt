...
class GithubUsersRepositoryImpl(
  private val  dataSource: GithubUsersDataSource
    ...
    override suspend fun getDetailUsers(username: String?): Flow<MainActivityViewState<DetailUsersResponse>> {
        return flow {
            try {
    ...
    override suspend fun getFollowers(username: String?): Flow<MainActivityViewState<List<ItemsItem>>> {
        return flow {
            try {
    ...
    override suspend fun getFollowing(username: String?): Flow<MainActivityViewState<List<ItemsItem>>> {
        return flow {
            try {
